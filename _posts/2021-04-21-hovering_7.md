...
코로나 19의 상황 속에서 이번 해커톤의 경연이 운영진과 참가자 모두 쉽지 않았지만, 참가를 통하여 큰 경험도 되었고 즐겁고 유익한 시간이었습니다. 첫째, 기존 엑셀과 유사하지만 Power BI의 시각화 Tool을 업무와 연계한다면 빠르고 시각화에 큰 장점이 있다는 것을 경험하였고, 둘째 기업이 ESG에 대하여 지속적인 관심과 기회창출, 혁신 등의 해결 방안에 대한 고민도 필요할 때라고 생각되었습니다.
...
새로 배운 tool을 직접 활용해볼 수 있는 프로그램이었기 때문에 교육에도 몰입하는 데 도움이 많이 되었던 것 같습니다. 특히 주제가 회사의 업역이 아닌 사회의 문제라는 점에서, 문제를 해결하는 솔루션을 제시 하기 위해 조원 분들과 아이디어를 함께 논의하고 발전시켜나가는 과정이 유익한 경험이었습니다. 전통시장 관련 공공 데이터를 직접 전처리 하고 표현해내기까지 서툴지만 새로운 도전이었고, 앞으로도 현업에서나 일상에서 다양한 관점으로 문제를 바라보고자 합니다.
...
Power BI라는 새로운 Tool의 우수한 기능들을 직접 경험함과 동시에, 사회의 문제들에 대해 관심을 갖는 계기를 마련했다는 점에서 좋은 경험이었습니다. 이번 이벤트를 계기로 해커톤에 참여했던 인원들에 한정되는게 아닌 GS건설 전 임직원들의 관심을 갖을 수 있는 기회로 만들어 나가는게 진정 중요한 숙제인 것 같습니다.
...
- [주차장 /  전국주차장정보표준데이터](https://www.data.go.kr/tcs/dss/selectStdDataDetailView.do){:target="_blank"}
