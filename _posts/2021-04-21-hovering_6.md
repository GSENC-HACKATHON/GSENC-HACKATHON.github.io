...
공공데이터를 이용하여 지도에 구현하기 위하여 Power BI 프로그램을 활용하였으나, 처음 접해보는 프로그램이기에 팀원들이 생각하고 계획했던 내용을 구현하고자 하는데 한계점이 많이 있었습니다. 교육을 실시하긴 하였으나 프로그램을 활용하면서 발생한 오류에 즉각적인 대응이 어려워 다소 시간낭비가 많았던 것이 좀 아쉬웠으며, 의도한 방향과 같은 결과물을 만들어 낼 수 있도록 프로그램활용 지원인력이 더 많이 있었으면 좋을 것 같다는 생각이 들었습니다. 하지만, 사업부문의 분위기가 안좋은 상황에서도 선후배직원들과 함께 새로운 것에 도전하면서 배웠던 내용(파워BI 프로그램, 공동데이터 활용방법 등)에 대해서는 유익한 시간이 될 수 있었던 것 같습니다.

![](/files/post/6/1_6_pic_1.jpg)
